...
plink --bfile axiom_corect_nf_ab_20130612 --check-sex --out QC_sexcheck
...
plink --bfile axiom_corect_nf_ab_20130612 --remove sexcheck_removeIndi.txt --make-bed --out GWAS_QC_sexcheck
...
plink --bfile GWAS_QC_subj_missGenotype --geno 0.05 --make-bed --out GWAS_QC_SNP_missGenotype
...
mv GWAS_QC_MAF.bed axiom_corect_nf_ab_20130612_QC.bed
mv GWAS_QC_MAF.bim axiom_corect_nf_ab_20130612_QC.bim
mv GWAS_QC_MAF.fam axiom_corect_nf_ab_20130612_QC.fam

#### Create frequency file ####

plink --freq --bfile axiom_corect_nf_ab_20130612_QC --out axiom_corect_nf_ab_20130612_QC_freq-file
